...
// var choice=prompt(player1 +"chose heads/tails")


//  var coin =prompt("chose head/tail" , "head/tail");
...
// else if(round === 1){
// alert( "head is win tail is lose");
// }
// else if(round ===0){
// alert("tail is win head is lose");
// }




// var alplg="ABCDEFGHIJKLMNOPQRSTUVWXYZ"
// var spcial="!@#$%^&*()"
// var alpsm="abcdefghijklmnopqrstuvwxyz"
// var num ="1234567890"
// var pass =;
// var random="";
// for(var i=0;i>arr.length;i++){
   
// } console.log(random =Math.random(arr)*arr.length)
...
// var passwordwords ="ABCD@678#$ENvwOPQRS78tux590yzFGHIJ!%^&*()KLM5690TUVWXYZ"
// var pass = 10
// var password = "";

// for(var i=0; i<pass; i++){
//  console.log( Math.floor(Math.random(pass)*passwordwords))
